class UsersController < ApplicationController
    ...
    def update 
        ...
        user.update((email: user_params[:user][:email], points: [:user][:points], password: params[:user][:password], user_name: params[:user][:username], name: params[:user][:name], surname: params[:user][:surname], n_of_reports: 0))
        render json: user
    end
